...
const cursos = [
  ...
  { code: 'Introducción a Matemáticas Discretas',  sem: 1, col: 2, type: 'common',    name: 'Introducción a Matemáticas Discretas' },
  { code: 'Física I',                              sem: 1, col: 3, type: 'common',    name: 'Física I' },
  { code: 'Herramientas Computacionales',           sem: 1, col: 4, type: 'common',    name: 'Herramientas Computacionales' },
  { code: 'Química',                               sem: 1, col: 5, type: 'common',    name: 'Química' },
  { code: 'Introducción a la Ingeniería',          sem: 1, col: 6, type: 'common',    name: 'Introducción a la Ingeniería' },

  // Semestre 2
  { code: 'Cálculo Diferencial e Integral',        sem: 2, col: 1, type: 'common',    name: 'Cálculo Diferencial e Integral' },
  { code: 'Álgebra Lineal',                        sem: 2, col: 2, type: 'common',    name: 'Álgebra Lineal' },
  { code: 'Física II',                             sem: 2, col: 3, type: 'common',    name: 'Física II' },
  { code: 'Programación',                          sem: 2, col: 4, type: 'specialty', name: 'Programación' },
  { code: 'Introducción a las Geociencias',        sem: 2, col: 5, type: 'common',    name: 'Introducción a las Geociencias' },

  // Semestre 3
  { code: 'Cálculo Avanzado',                      sem: 3, col: 1, type: 'common',    name: 'Cálculo Avanzado' },
  { code: 'Ecuaciones Diferenciales',              sem: 3, col: 2, type: 'common',    name: 'Ecuaciones Diferenciales' },
  { code: 'Economía Industrial',                   sem: 3, col: 3, type: 'specialty', name: 'Economía Industrial' },
  { code: 'Taller de Industrias',                  sem: 3, col: 4, type: 'specialty', name: 'Taller de Industrias' },
  { code: 'Comunicación Oral y Escrita',           sem: 3, col: 5, type: 'common',    name: 'Comunicación Oral y Escrita' },
...
// 2) Agarra el contenedor de la malla
const container = document.getElementById('malla-container');

// 3) Crea las cabeceras de semestre en la fila 1
for (let sem = 1; sem <= 10; sem++) {
  ...
  // grid-row-start: 1 viene ya del CSS para .semester-label
  container.appendChild(label);
}

// 4) Pinta cada curso en la fila (= columna original + 1), columna = semestre
cursos.forEach(c => {
  ...
  d.style.gridRowStart    = c.col + 1;  // +1 para dejar la fila 1 libre a las etiquetas
...
// 5) Lógica del modal (igual que antes)
const modal    = document.getElementById('modal');
const titleEl  = document.getElementById('modal-title');
const bodyEl   = document.getElementById('modal-body');
const closeBtn = document.getElementById('modal-close');

// Click en curso → abre modal
